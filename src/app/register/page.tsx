          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 dark:border-white/10 dark:bg-gray-800/50 dark:text-gray-100"
              />
            </div>
            <div>
